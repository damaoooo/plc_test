...
if __name__ == "__main__":
    ...
    my_dataset = ASTGraphDataModule(batch_size=1, num_workers=16, pool_size=31, data_path="uboot_dataset/cpg_file")
    ...
    load_checkpoint = "lightning_logs/version_14/checkpoints/last.ckpt"
