...
if __name__ == '__main__':
    ...
    converter = Converter(op_file=r'coreutil_dataset/op_file.pkl', read_op=True, max_length=500)
    # data_generator = DataGenerator(file_tree=file_tree, save_path='/home/damaoooo/mini_core/', converter=converter, read_cache=False)
    multi_datagen = DataGeneratorMultiProcessing(file_tree=file_tree, save_path='coreutil_dataset', converter=converter, read_cache=True)
    # data_generator.run()
    multi_datagen.run()
